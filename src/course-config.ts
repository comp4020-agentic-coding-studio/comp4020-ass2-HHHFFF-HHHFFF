...
//
// 126 is this repo's allocation, not a choice: the course committed it seven
// seconds after provisioning the repo (1b80b97, authored by the convenor,
// straight after the template import). Only the leading digit is ours.
