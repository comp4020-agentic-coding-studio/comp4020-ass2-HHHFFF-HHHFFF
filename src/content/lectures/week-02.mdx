...
import SpellingAlphabet from "../../components/SpellingAlphabet.astro";
...
because place value is exactly the redundancy the channel eats. But three
digits needed respelling outright:
